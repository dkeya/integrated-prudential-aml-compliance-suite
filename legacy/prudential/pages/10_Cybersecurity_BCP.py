...
class CyberDefenseOpsPage:
    ...
    def _generate_threat_map_data(self):
        ...
        # Simulate global threat sources
        ...
        with col2:
            ...
            for scanner in scanner_data:
                ...
                with col_scan[0]:
                    ...
                    st.markdown(f"<span style='color: {status_color}; font-size: 0.9rem;'>Status: {scanner['status']}</span>", unsafe_allow_html=True)
                with col_scan[1]:
    ...
    def _generate_vulnerability_trend(self):
        ...
        # Base vulnerability count with decreasing trend
        base_count = [45, 52, 48, 56, 62, 58, 51, 47]
        
        # Remediation rate with improving trend
        ...
        with col2:
            ...
            for reg in regulations:
                ...
                with col_reg[1]:
                    ...
                    st.markdown(f"<span style='color: {status_color}; font-weight: bold;'>{reg['status']}</span>", unsafe_allow_html=True)
                with col_reg[2]:
    ...
    def render_enhanced_dashboard(self):
        ...
        # Overview metrics - Enhanced with visual indicators
        ...
        with col1:
            ...
            <div style="background: {risk_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {risk_color};">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: {risk_color};">{'🚨 Critical' if risk_level == 'Critical' else '⚠️ High' if risk_level == 'High' else '🔍 Medium' if risk_level == 'Medium' else '✅ Low'}</span>
        ...
        with col2:
            ...
            <div style="background: {bcp_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {bcp_color};">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: {bcp_color};">{'🛡️ Optimal' if bcp_score >= 90 else '⚠️ Adequate' if bcp_score >= 75 else '🚨 Deficient'}</span>
        ...
        with col3:
            ...
            <div style="background: {controls_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {controls_color};">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: {controls_color};">{'✅ Optimal' if controls_score >= 90 else '⚠️ Effective' if controls_score >= 80 else '🔧 Needs Work'}</span>
        ...
        with col4:
            ...
            <div style="background: {compliance_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {compliance_color};">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: {compliance_color};">{'✅ Compliant' if compliance_score >= 90 else '⚠️ Partial' if compliance_score >= 80 else '🚨 Deficient'}</span>
    ...
    def display_threat_analysis(self, threat_analysis: Dict[str, Any]):
        """Display threat analysis section - PRESERVED"""
    ...
    def display_risk_assessment(self, risk_assessment: Dict[str, Any]):
        """Display cybersecurity risk assessment - PRESERVED"""
    ...
    def display_business_continuity(self, bcp_analysis: Dict[str, Any]):
        """Display business continuity analysis - PRESERVED"""
    ...
    def display_security_controls(self, controls_assessment: Dict[str, Any]):
        """Display security controls assessment - PRESERVED"""
    ...
    def display_recommendations(self, recommendations: List[Dict[str, Any]]):
        """Display security recommendations - PRESERVED"""
    ...
    def run(self):
        ...
        # Cyber Defense Header
        self.render_cyber_defense_header()
        
        # Threat Radar Marquee
