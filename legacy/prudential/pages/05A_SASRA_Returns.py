...
class SASRAReturnsPage:
    ...
    def render_compliance_marquee(self):
        ...
        today = datetime.now()
        next_deadline = datetime(today.year, 3, 31)  # Q1 deadline
        ...
        ">
            <div>
                ...
                <span style="margin-left: 10px;">
                    SASRA Q1 2024 Returns due in <strong>{days_to_deadline} days</strong> | 
    ...
    def render_strategic_kpis(self):
        ...
        with col2:
            ...
            <div style="background: #f8f9fa; padding: 1rem; border-radius: 10px; border-left: 4px solid {deadline_color};">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: {deadline_color};">Q1 2024</span>
    ...
    def render_sasra_rating_history(self):
        ...
        rating_data = pd.DataFrame({
            ...
            'Earnings': [2, 2, 2, 2, 2],
            'Liquidity': [2, 2, 2, 2, 2],
            'Regulatory Score': [78, 85, 88, 89, 92]  # Added regulatory score
        })
        ...
        with col1:
            ...
            for i, component in enumerate(rating_components):
                fig.add_trace(go.Scatter(
                    ...
                    text=[f"{rating_data[component].iloc[i]}" for i in range(len(rating_data))],
        ...
        with col2:
            # Regulatory compliance score trend
            fig = px.line(
                rating_data,
                x='Period',
                y='Regulatory Score',
    ...
    def render_returns_generator_tab(self):
        ...
        with col1:
            ...
            # Enhanced: Add AI-powered validation
    ...
    def _render_quick_insights(self, returns_data):
        ...
        if insights:
            ...
            with col1:
                st.metric("Next Quarter Compliance", f"{insights['predictive_compliance']['next_quarter_compliance']}%")
            
            with col2:
                st.metric("Anomalies Detected", insights['anomaly_detection']['anomalies_detected'])
            
            with col3:
                st.metric("Regulatory Trend", insights['regulatory_trends']['trend'])
    ...
    def render_submission_tracker(self):
        ...
        # Submission performance dashboard
        st.markdown("##### 📊 Submission Performance Analytics")
        
        col1, col2, col3 = st.columns(3)
        
        with col1:
            on_time_rate = 100  # All submissions on time except one
            st.metric(
    ...
    def run(self):
        ...
        # Main content with preserved functionality
