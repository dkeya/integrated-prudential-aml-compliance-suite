...
class PricingOptimizer:
    ...
    def calculate_comprehensive_pricing(self, product_type, loan_amount, loan_term, risk_category, 
                                       credit_score, debt_to_income, collateral_coverage, 
                                       cost_of_funds, operating_cost, target_roa, 
                                       capital_charge, risk_premium, market_rate, 
        ...
        risk_provision = self._calculate_risk_provision_comprehensive(risk_category, credit_score, debt_to_income)
    ...
    def _calculate_risk_provision_comprehensive(self, risk_category, credit_score, debt_to_income):
    ...
    def calculate_rate_sensitivity(self, base_rate, cost_change):
