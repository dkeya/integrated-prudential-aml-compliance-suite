...
from sacco_core.audit import audit_logger  # ✅ unified audit logger
...
class OperationsTATAnalyzer:
    ...
    def __init__(self, audit_logger_instance: Optional[Any] = None):
        # ✅ use shared audit logger (can be injected for tests, or defaults to global)
        self.audit_logger = audit_logger_instance or audit_logger
    ...
    def analyze_operations_tat(self) -> Dict[str, Any]:
        ...
        """
        self._audit(
            action="operations_tat_analysis_started",
        ...
        try:
            ...
            self._audit(
                action="operations_tat_analysis_completed",
                details={
                    "timestamp": datetime.now().isoformat(),
                    "loan_rows": len(loan_data),
            ...
            self._audit(
                action="operations_tat_analysis_error",
                details={
                    "timestamp": datetime.now().isoformat(),
                    "error": str(e)
                }
    ...
    def _extract_loan_operations_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            self._audit(
                action="loan_operations_data_error",
                details={"error": str(e)}
            )
            return pd.DataFrame()
    ...
    def _extract_service_requests_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            self._audit(
                action="service_requests_data_error",
                details={"error": str(e)}
            )
            return pd.DataFrame()
    ...
    def _extract_transaction_processing_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            self._audit(
                action="transaction_processing_data_error",
                details={"error": str(e)}
            )
            return pd.DataFrame()
    ...
    def _analyze_loan_operations_tat(self, loan_data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            self._audit(
                action="loan_operations_tat_error",
                details={"error": str(e)}
            )
            return self._get_empty_loan_analysis()
    ...
    def _analyze_service_operations_tat(self, service_data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            self._audit(
                action="service_operations_tat_error",
                details={"error": str(e)}
            )
            return self._get_empty_service_analysis()
    ...
    def _analyze_transaction_operations_tat(self, transaction_data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            self._audit(
                action="transaction_operations_tat_error",
                details={"error": str(e)}
            )
            return self._get_empty_transaction_analysis()
    ...
    def _calculate_overall_performance(self, loan_data: pd.DataFrame, service_data: pd.DataFrame, transaction_data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            self._audit(
                action="overall_performance_error",
                details={"error": str(e)}
            )
            return {
    ...
    def _calculate_tat_by_request_type(self, service_data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            self._audit(
                action="tat_by_request_type_error",
                details={"error": str(e)}
            )
            return {}
    ...
    def _calculate_tat_by_transaction_type(self, transaction_data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            self._audit(
                action="tat_by_transaction_type_error",
                details={"error": str(e)}
            )
            return {}
    ...
    # ✅ Unified internal audit helper
    def _audit(self, action: str, details: Dict[str, Any]) -> None:
        """
        Internal helper to safely log to the shared audit logger.

        Uses a generic 'system' user & 'operations_tat' module since this is a
        backend analytics component (no direct Streamlit session here).
        """
        try:
            self.audit_logger.log_event(
                user="system",
                action=action,
                module="operations_tat",
                details=details
            )
        except Exception:
            # Never break analytics because audit logging failed
            logger.debug("Audit logging failed in OperationsTATAnalyzer", exc_info=True)
            pass