...
from core.rbac import RBACManager, check_permission, get_current_role, get_current_username
from core.audit import audit_logger
from core.sidebar import render_sidebar
from core.analytics.member_value import MemberValueAnalyzer  # assumes you've moved this under core/
...
class MemberValuePage:
            ...
            for metric in loyalty_metrics:
                ...
                with col_met[2]:
                    st.markdown(
                        ...
                        f"{'Strong' if metric['value'] >= 75 else 'Good' if metric['value'] >= 60 else 'Needs Work'}"
                        f"</span>",
                        unsafe_allow_html=True
                    )
        ...
        with col2:
            ...
            for metric in growth_metrics:
                ...
                with col_met[1]:
                    trend_color = "#22c55e" if metric['trend'] == "↑" else "#dc2626" if metric['trend'] == "↓" else "#f59e0b"
                    st.markdown(
                        f"<span style='color: {trend_color}; font-weight: bold;'>{metric['value']}%</span>",
                        unsafe_allow_html=True
                    )
                with col_met[2]:
    ...
    def render_member_value_dashboard(self):
        ...
        try:
            ...
            with col1:
                ...
                value_color = "#f59e0b" if total_member_value > 1_000_000_000 else "#8b5cf6" if total_member_value > 500_000_000 else "#7c3aed"
                ...
                <div style="background: {value_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {value_color};">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: {value_color};">
                            {'💰 Elite Portfolio' if total_member_value > 1_000_000_000 else
                             '💎 Strong Portfolio' if total_member_value > 500_000_000 else
                             '📈 Growing Portfolio'}
                        </span>
            ...
            with col2:
                ...
                avg_color = "#f59e0b" if avg_member_value > 500_000 else "#8b5cf6" if avg_member_value > 250_000 else "#7c3aed"
                ...
                <div style="background: {avg_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {avg_color};">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: {avg_color};">
                            {'👑 Premium' if avg_member_value > 500_000 else
                             '💎 High Value' if avg_member_value > 250_000 else
                             '📈 Growth Potential'}
                        </span>
                ...
                <div style="background: {risk_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {risk_color};">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: {risk_color};">
                            {'🚨 High Alert' if total_at_risk > 100 else
                             '⚠️ Monitor' if total_at_risk > 50 else
                             '✅ Controlled'}
                        </span>
            ...
            with col4:
                ...
                <div style="background: {engagement_color}15; padding: 1rem; border-radius: 10px; border-left: 4px solid {engagement_color};">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: {engagement_color};">
                            {'💖 Highly Engaged' if avg_engagement >= 80 else
                             '📱 Active' if avg_engagement >= 70 else
                             '😕 Needs Attention'}
                        </span>
    ...
    # PRESERVED HELPER METHODS (currently placeholders – can be expanded later)
